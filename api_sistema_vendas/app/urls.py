...
from .views import fornecedor_list, funcionario_list, cargo_list, preco_list, faixa_list, genero_list, produto_list, categoria_list, plataforma_list, venda_list, vendaitem_list, cliente_list
